...
struct AnchorProcessState {
    ...
    IsPackageOwnedPathFn originalIsPackageOwnedPath = nullptr;
    IsBpfBackingPathFn originalIsBpfBackingPath = nullptr;
    void* originalStrcasecmp = nullptr;
    void* originalEqualsIgnoreCase = nullptr;
